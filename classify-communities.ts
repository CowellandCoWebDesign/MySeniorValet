...
async function classifyCommunities() {
  ...
  try {
    ...
    `);
    console.log(`✓ Classified ${hudUpdate.rowCount} HUD properties`);
    ...
    `);
    console.log(`✓ Classified ${mobileUpdate.rowCount} mobile home parks`);
    ...
    `);
    console.log(`✓ Classified ${activeAdultUpdate.rowCount} active adult communities`);
    ...
    `);
    console.log(`✓ Classified ${memoryUpdate.rowCount} memory care communities`);
    ...
    const assistedUpdate = await db.execute(sql`
      ...
      AND (
        ...
        LOWER(name) LIKE '%assisted%living%'
      )
    `);
    console.log(`✓ Classified ${assistedUpdate.rowCount} assisted living communities`);
    ...
    const skilledUpdate = await db.execute(sql`
      ...
      AND (
        ...
        LOWER(name) LIKE '%skilled%nursing%'
      )
    `);
    console.log(`✓ Classified ${skilledUpdate.rowCount} skilled nursing facilities`);
    ...
    `);
    console.log(`✓ Classified ${boardCareUpdate.rowCount} board and care homes`);
    ...
    `);
    console.log(`✓ Classified ${veteranUpdate.rowCount} veteran housing communities`);
    ...
    `);
    console.log(`✓ Classified ${independentUpdate.rowCount} independent living communities`);
    ...
    console.log(`   Unclassified: ${Number(total.count) - Number(classified.count)}`);
