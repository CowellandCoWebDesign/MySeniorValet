...
export default function BasicSearch({ initialFilters = [] }: { initialFilters?: string[] }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pb-16">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-full px-4 py-2 shadow-md border border-gray-200 dark:border-gray-600">
              ...
              {(filteredCommunities?.length || 0) > (visibleCommunities?.length || 0) && (
                <div className="text-xs text-blue-600 dark:text-blue-400">
                  {filteredCommunities?.length || 0} total found
                </div>
              )}
            </div>
          </div>
      ...
      <div className="sticky top-20 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md z-30 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="px-4 py-4">
