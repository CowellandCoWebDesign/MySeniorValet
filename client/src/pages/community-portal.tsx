  ...
  const plans = [
    {
      ...
      features: [
        { text: 'Enhanced listing with 10 photos', included: true },
    ...
    },
    {
      ...
      priceValue: 299,
      tier: 'premium',
      tagline: 'Complete visibility package',
      description: 'Includes Matterport 3D Tour',
      features: [
        { text: 'Everything in Essential, plus:', header: true },
        { text: '✨ 1 Matterport 3D Tour included', included: true, highlight: true },
        { text: 'Featured search ranking', included: true },
        { text: 'CRM integration (Aline, Yardi)', included: true },
        { text: 'Tour scheduler & messaging', included: true },
    ...
    },
    {
      ...
      priceValue: 599,
      tier: 'enterprise',
      tagline: 'Full platform capabilities',
      description: 'For multi-community portfolios',
      comingSoon: true,
      features: [
        { text: 'Everything in Premium, plus:', header: true },
        { text: '🏆 5 Matterport 3D Tours included', included: true, highlight: true },
        { text: 'All 6 RMS integrations', included: true },
        { text: 'Revenue optimization AI', included: true },
        { text: 'Multi-community dashboard', included: true },
