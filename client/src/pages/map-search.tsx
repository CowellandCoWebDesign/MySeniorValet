...
export default function MapSearch() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      {/* Legend Button - Top Right on Map */}
      {viewMode === 'map' && (
            ...
            <DrawerTrigger asChild>
              <Button 
                ...
                className={isDarkMode 
                  ? 'border-gray-600 bg-gray-800/95 backdrop-blur text-white hover:bg-gray-700 shadow-xl' 
                  : 'border-gray-300 bg-white/95 backdrop-blur text-gray-900 hover:bg-gray-50 shadow-xl'
                }
              >
