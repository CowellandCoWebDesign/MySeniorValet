          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-700 mb-4">
                  With a background in web development and a passion for helping families navigate complex decisions, Scott has created a comprehensive platform that covers communities across all 50 states and territories, with plans for international expansion.
                </p>
