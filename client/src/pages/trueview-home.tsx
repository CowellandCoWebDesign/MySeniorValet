          ...
          <div className="flex space-x-4 overflow-x-auto pb-2 scrollbar-hide horizontal-card-gradient">
            ...
            {(coastalLoading || trendingLoading) ? (
              ...
              Array.from({ length: 4 }).map((_, index) => (
                <Card key={index} className="overflow-hidden flex-shrink-0 w-52 h-[28rem] border border-gray-200 animate-pulse">
              ...
              <Card className="overflow-hidden flex-shrink-0 w-52 h-[28rem] animate-float coastal-card" style={{animationDelay: `${index * 0.2}s`}}>
            ...
            {californiaLoading ? (
              ...
              (californiaCommunities || []).map((community: any, index) => (
                <Link key={`california-${community.id}-${index}`} href={`/community/${community.id}`}>
                  <Card className="overflow-hidden flex-shrink-0 w-52 h-[28rem] animate-float california-card" style={{animationDelay: `${index * 0.2}s`}}>
                    <div className="relative">
                      <div className="aspect-[4/3] bg-gray-200 flex items-center justify-center">
                        <Home className="w-12 h-12 text-gray-400" />
                      </div>
