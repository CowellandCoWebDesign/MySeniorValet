    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <section className="relative hero-mobile-safe bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
            alt="Happy elderly person enjoying activities"
