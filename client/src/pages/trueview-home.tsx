...
export default function TrueViewHome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      {/* Understanding Costs - Comprehensive Section */}
      <section className="px-4 py-8 gradient-card">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-sm">
            Complete breakdown of costs, payment options, and financial assistance available
          </p>
        </div>

        {/* Monthly Cost Ranges by Care Level */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">California Monthly Costs by Care Level</h3>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="font-medium text-gray-900">Independent Living</span>
                <span className="text-lg font-bold text-blue-600">$3,500 - $6,500/mo</span>
              </div>
              <p className="text-xs text-gray-600">Apartments, dining, activities, transportation</p>
            </div>
            
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="font-medium text-gray-900">Assisted Living</span>
                <span className="text-lg font-bold text-blue-600">$4,500 - $8,500/mo</span>
              </div>
              <p className="text-xs text-gray-600">Personal care, medication management, meals</p>
            </div>
            
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="font-medium text-gray-900">Memory Care</span>
                <span className="text-lg font-bold text-blue-600">$7,000 - $12,000/mo</span>
              </div>
              <p className="text-xs text-gray-600">Specialized dementia care, secure environment</p>
            </div>
            
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="font-medium text-gray-900">Skilled Nursing</span>
                <span className="text-lg font-bold text-blue-600">$9,000 - $15,000/mo</span>
              </div>
              <p className="text-xs text-gray-600">24-hour medical care, rehabilitation services</p>
            </div>
          </div>
        </div>
        ...
        {/* Move-In Costs */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Typical Move-In Costs</h3>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm font-semibold">$1,000-$5,000</div>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-blue-600 font-bold text-lg">1×</span>
              ...
              <div className="text-sm font-semibold">1-2 months rent</div>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-2">
              ...
              <div className="text-sm font-semibold">$150-$500</div>
            </div>
          </div>
        </div>
        ...
        {/* Payment Options */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Payment & Financial Assistance Options</h3>
          <div className="space-y-3">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-semibold text-blue-800">VA Benefits (Aid & Attendance)</span>
              </div>
              <p className="text-xs text-blue-700 mb-2">
                Up to $2,500/month for veterans, $1,500 for surviving spouses
              </p>
              <div className="text-xs text-blue-600">✓ Service-connected disability or wartime service required</div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-semibold text-green-800">Long-Term Care Insurance</span>
              </div>
              <p className="text-xs text-green-700 mb-2">
                May cover $3,000-$6,000/month depending on policy
              </p>
              <div className="text-xs text-green-600">✓ Check elimination period and benefit details</div>
            </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-semibold text-purple-800">Medicaid (Medi-Cal in CA)</span>
              </div>
              <p className="text-xs text-purple-700 mb-2">
                Covers skilled nursing care for qualified applicants
              </p>
              <div className="text-xs text-purple-600">✓ Income and asset limits apply</div>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm font-semibold text-orange-800">Bridge Financing</span>
              </div>
              <p className="text-xs text-orange-700 mb-2">
                Short-term financing while waiting for home sale or benefits
              </p>
              <div className="text-xs text-orange-600">✓ Available through specialized lenders</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          <div className="flex items-start space-x-2">
            ...
            <div>
              <h4 className="text-sm font-semibold text-yellow-800 mb-2">Additional Costs to Consider</h4>
              <ul className="text-xs text-yellow-700 space-y-1">
                <li>• Care level increases (additional $500-$2,000/month)</li>
                <li>• Medical supplies and equipment not covered</li>
                <li>• Transportation for medical appointments</li>
                <li>• Personal items and clothing replacement</li>
                <li>• Therapy services beyond basic coverage</li>
              </ul>
            </div>
          </div>
        </div>
