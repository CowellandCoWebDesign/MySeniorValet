        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mt-4 sm:mt-6">
              <TabsList className="flex sm:grid w-full overflow-x-auto sm:overflow-visible sm:grid-cols-5 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 p-2 sm:p-1.5 rounded-2xl shadow-xl border-2 border-gray-200 dark:border-gray-600 gap-2 sm:gap-1.5">
                <TabsTrigger 
                  value="community-info" 
                  className="relative flex flex-col items-center gap-0.5 sm:gap-1 py-3 sm:py-3.5 px-4 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-transparent hover:border-blue-300 dark:hover:border-blue-500 text-gray-600 dark:text-gray-400 font-medium hover:text-blue-600 dark:hover:text-blue-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-500 data-[state=active]:to-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-[1.02] sm:data-[state=active]:scale-[1.08] data-[state=active]:border-blue-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[100px] sm:min-w-0"
                >
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl sm:text-xl">🏘️</span>
                    <span className="text-sm sm:text-sm font-bold hidden sm:inline">Community Info</span>
                    <span className="text-sm sm:text-sm font-bold sm:hidden">Info</span>
                  </div>
                ...
                <TabsTrigger 
                  value="tours" 
                  className="relative flex flex-col items-center gap-0.5 sm:gap-1 py-3 sm:py-3.5 px-4 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-transparent hover:border-teal-300 dark:hover:border-teal-500 text-gray-600 dark:text-gray-400 font-medium hover:text-teal-600 dark:hover:text-teal-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-teal-500 data-[state=active]:to-cyan-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-[1.02] sm:data-[state=active]:scale-[1.08] data-[state=active]:border-teal-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[100px] sm:min-w-0"
                >
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl sm:text-xl">🗓️</span>
                    <span className="text-sm sm:text-sm font-bold">Tours</span>
                  </div>
                  <span className="text-[10px] sm:text-xs opacity-75 font-normal hidden sm:block">
                    Schedule Visit
                  </span>
                ...
                <TabsTrigger 
                  value="availability" 
                  className="relative flex flex-col items-center gap-0.5 sm:gap-1 py-3 sm:py-3.5 px-4 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-transparent hover:border-green-300 dark:hover:border-green-500 text-gray-600 dark:text-gray-400 font-medium hover:text-green-600 dark:hover:text-green-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-green-500 data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-[1.02] sm:data-[state=active]:scale-[1.08] data-[state=active]:border-green-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[100px] sm:min-w-0"
                >
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl sm:text-xl">🏠</span>
                    <span className="text-sm sm:text-sm font-bold">Availability</span>
                  </div>
                  <span className="text-[10px] sm:text-xs opacity-75 font-normal hidden sm:block">
                    Units & Pricing
                  </span>
                ...
                <TabsTrigger 
                  ...
                  className={`relative flex flex-col items-center gap-0.5 sm:gap-1 py-3 sm:py-3.5 px-4 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-transparent hover:border-purple-300 dark:hover:border-purple-500 text-gray-600 dark:text-gray-400 font-medium hover:text-purple-600 dark:hover:text-purple-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-purple-500 data-[state=active]:to-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-[1.02] sm:data-[state=active]:scale-[1.08] data-[state=active]:border-purple-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[100px] sm:min-w-0 ${liveIntelligenceReady ? 'animate-pulse-once ring-2 ring-purple-400 ring-offset-2 ring-offset-white dark:ring-offset-gray-900' : ''}`}
                >
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl sm:text-xl">📊</span>
                    <span className="text-sm sm:text-sm font-bold hidden sm:inline">Market Data</span>
                    <span className="text-sm sm:text-sm font-bold sm:hidden">Market</span>
                ...
                <TabsTrigger 
                  value="reviews" 
                  className="relative flex flex-col items-center gap-0.5 sm:gap-1 py-3 sm:py-3.5 px-4 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-transparent hover:border-orange-300 dark:hover:border-orange-500 text-gray-600 dark:text-gray-400 font-medium hover:text-orange-600 dark:hover:text-orange-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-orange-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-[1.02] sm:data-[state=active]:scale-[1.08] data-[state=active]:border-orange-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[100px] sm:min-w-0"
                >
                  <div className="flex items-center gap-1.5">
                    <span className="text-xl sm:text-xl">⭐</span>
                    <span className="text-sm sm:text-sm font-bold">Reviews</span>
