        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mt-4 sm:mt-6">
              ...
              <div className="sm:hidden mb-2 text-center text-xs text-gray-500 dark:text-gray-400 animate-pulse">
                ← Swipe to see more tabs →
              </div>
              <TabsList className="flex sm:grid w-full overflow-x-auto sm:overflow-visible sm:grid-cols-5 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 p-3 sm:p-1.5 rounded-2xl shadow-xl border-2 border-gray-200 dark:border-gray-600 gap-3 sm:gap-1.5 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                <TabsTrigger 
                  value="community-info" 
                  className="relative flex flex-col items-center justify-center gap-1 py-4 px-5 sm:py-3.5 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 sm:border-transparent hover:border-blue-400 dark:hover:border-blue-500 text-gray-700 dark:text-gray-300 font-semibold hover:text-blue-600 dark:hover:text-blue-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-500 data-[state=active]:to-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-105 sm:data-[state=active]:scale-[1.08] data-[state=active]:border-blue-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[120px] sm:min-w-0"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-1.5">
                    ...
                    <span className="text-base sm:text-sm font-bold sm:hidden">Info</span>
                  </div>
                ...
                <TabsTrigger 
                  value="tours" 
                  className="relative flex flex-col items-center justify-center gap-1 py-4 px-5 sm:py-3.5 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 sm:border-transparent hover:border-teal-400 dark:hover:border-teal-500 text-gray-700 dark:text-gray-300 font-semibold hover:text-teal-600 dark:hover:text-teal-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-teal-500 data-[state=active]:to-cyan-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-105 sm:data-[state=active]:scale-[1.08] data-[state=active]:border-teal-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[120px] sm:min-w-0"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-1.5">
                    <span className="text-2xl sm:text-xl">🗓️</span>
                ...
                <TabsTrigger 
                  value="availability" 
                  className="relative flex flex-col items-center justify-center gap-1 py-4 px-5 sm:py-3.5 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 sm:border-transparent hover:border-green-400 dark:hover:border-green-500 text-gray-700 dark:text-gray-300 font-semibold hover:text-green-600 dark:hover:text-green-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-green-500 data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-105 sm:data-[state=active]:scale-[1.08] data-[state=active]:border-green-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[120px] sm:min-w-0"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-1.5">
                ...
                <TabsTrigger 
                  ...
                  className={`relative flex flex-col items-center justify-center gap-1 py-4 px-5 sm:py-3.5 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 sm:border-transparent hover:border-purple-400 dark:hover:border-purple-500 text-gray-700 dark:text-gray-300 font-semibold hover:text-purple-600 dark:hover:text-purple-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-purple-500 data-[state=active]:to-indigo-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-105 sm:data-[state=active]:scale-[1.08] data-[state=active]:border-purple-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[120px] sm:min-w-0 ${liveIntelligenceReady ? 'animate-pulse-once ring-2 ring-purple-400 ring-offset-2 ring-offset-white dark:ring-offset-gray-900' : ''}`}
                >
                  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-1.5">
                    <span className="text-2xl sm:text-xl">📊</span>
                ...
                <TabsTrigger 
                  value="reviews" 
                  className="relative flex flex-col items-center justify-center gap-1 py-4 px-5 sm:py-3.5 sm:px-4 rounded-xl transition-all duration-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 sm:border-transparent hover:border-orange-400 dark:hover:border-orange-500 text-gray-700 dark:text-gray-300 font-semibold hover:text-orange-600 dark:hover:text-orange-400 data-[state=active]:bg-gradient-to-br data-[state=active]:from-orange-500 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:scale-105 sm:data-[state=active]:scale-[1.08] data-[state=active]:border-orange-400 data-[state=active]:font-bold data-[state=active]:z-10 flex-shrink-0 min-w-[120px] sm:min-w-0"
                >
                  <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-1.5">
                    <span className="text-2xl sm:text-xl">⭐</span>
