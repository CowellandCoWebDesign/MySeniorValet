...
import { ArrowLeft, Home, Phone, Calendar, Heart, MessageSquare, Star, DollarSign, MapPin, Info, 
         ...
         ChevronDown, ChevronUp, Building, FileText, AlertTriangle, TrendingUp, Crown, Gem, Brain, AlertCircle, Truck, Package, Stethoscope, TrendingDown, Minus, BarChart3, Loader2, Camera, Circle } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <Tabs defaultValue="market-data" className="w-full mt-6">
              <TabsList className="grid w-full grid-cols-5 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 p-2 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <TabsTrigger 
                  value="reviews" 
                  className="flex flex-col items-center gap-1 py-4 px-6 rounded-lg transition-all duration-300 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 shadow-sm data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-600 data-[state=active]:to-amber-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:transform data-[state=active]:scale-105 data-[state=active]:border-orange-300 hover:bg-orange-50 dark:hover:bg-orange-900/30 hover:border-orange-300 dark:hover:border-orange-500 text-gray-700 dark:text-gray-300 font-semibold"
                >
                  <div className="flex items-center gap-2">
