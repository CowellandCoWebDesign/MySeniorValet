...
export default function MySeniorValetHome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Universal Header with transparent-to-solid transition */}
      <UniversalHeader isHeroPage={true} heroHeight={600} />

      {/* Hero Section with Search - Adjusted for fixed header */}
      <section className="relative min-h-screen bg-black pt-24">
        ...
        <div className="relative hero-content min-h-screen pt-8 sm:pt-12 md:pt-16 pb-3 md:pb-4 mobile-keyboard-safe">
