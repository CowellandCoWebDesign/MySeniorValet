          ...
          <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-8">
            <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group" aria-label="MySeniorValet Home - Senior Living Community Search">
              ...
              <div className="flex flex-col">
                <span className="text-base sm:text-xl font-bold text-blue-600 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text supports-[background-clip:text]:text-transparent group-hover:scale-105 transform transition-all duration-300">MySeniorValet</span>
              ...
              <SheetContent className="w-[85vw] max-w-sm">
                <div className="flex flex-col space-y-6 mt-8">
                  <div className="flex items-center space-x-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex flex-col">
                      <span className="text-lg font-bold text-gray-900 dark:text-white">MySeniorValet</span>
