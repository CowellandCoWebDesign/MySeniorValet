...
/**
 * Build a complete, de-duplicated location line for a community card.
 *
...
export function CommunityCard({
  ...
  const locationLine = composeLocationLine(displayAddress, community.city, community.state);
