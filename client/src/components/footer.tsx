          ...
          {!isLoading && formattedStats ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div className="flex items-center justify-center space-x-2">
                ...
                <div>
                  <div className="text-2xl font-bold text-white">{formattedStats.totalCommunities}</div>
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <div>
                  <div className="text-lg font-bold text-white">{formattedStats.coverage}</div>
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <div>
                  <div className="text-lg font-bold text-white">{formattedStats.dataQuality}</div>
