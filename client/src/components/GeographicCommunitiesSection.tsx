        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="text-center mt-6">
              <Link to={getLocationSearchUrl('Hawaii')} data-testid="link-explore-hawaii">
      ...
      <section data-testid="section-fortworth-communities" className="relative px-4 py-12 overflow-hidden rounded-xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="text-center mt-6">
              <Link to={getLocationSearchUrl('Fort Worth, Texas')} data-testid="link-explore-fortworth">
      ...
      <section data-testid="section-newyork-communities" className="relative px-4 py-12 overflow-hidden rounded-xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="text-center mt-6">
              <Link to={getLocationSearchUrl('New York')} data-testid="link-explore-newyork">
          ...
          <div className="relative">
            ...
            <div ref={canadianSliderRef} className="flex gap-4 overflow-x-auto overflow-y-hidden pb-4 scrollbar-thin scrollbar-thumb-red-500 dark:scrollbar-thumb-red-400" style={{scrollBehavior: 'smooth'}}>
              {canadianLoading ? (
                ...
                <Link to={getLocationSearchUrl('canada')} data-testid="link-canadian-promo">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to={getLocationSearchUrl('Puerto Rico')} data-testid="link-puertorico-view-all">
          ...
          {puertoRicoLoading ? (
            ...
            <div className="text-center text-gray-600 dark:text-gray-400">
              <Button variant="outline" className="mt-2" onClick={() => setLocation(getLocationSearchUrl('Puerto Rico'))} data-testid="button-search-puertorico">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to={getLocationSearchUrl('Peru')} data-testid="link-peru-view-all">
          ...
          {peruLoading ? (
            ...
            <div className="text-center text-gray-600 dark:text-gray-400">
              <Button variant="outline" className="mt-2" onClick={() => setLocation(getLocationSearchUrl('Peru'))} data-testid="button-search-peru">
      ...
      <section data-testid="section-cuba-communities" className="relative px-4 py-12 overflow-hidden rounded-xl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="text-center mt-6">
              <Link to={getLocationSearchUrl('Cuba')} data-testid="link-explore-cuba">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to={getLocationSearchUrl('Costa Rica')} data-testid="link-costarica-view-all">
          ...
          {costaRicaLoading ? (
            ...
            <div className="text-center text-gray-600 dark:text-gray-400">
              <Button variant="outline" className="mt-2" onClick={() => setLocation(getLocationSearchUrl('Costa Rica'))} data-testid="button-search-costarica">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to={getLocationSearchUrl('Panama')} data-testid="link-panama-view-all">
          ...
          {panamaLoading ? (
            ...
            <div className="text-center text-gray-600 dark:text-gray-400">
              <Button variant="outline" className="mt-2" onClick={() => setLocation(getLocationSearchUrl('Panama'))} data-testid="button-search-panama">
