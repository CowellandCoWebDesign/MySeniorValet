  ...
  try {
    ...
    const categories = [
      { name: "Healthcare", description: "Medical and health services",
        content: "Medical and health services", icon: "Stethoscope", color: "blue", display_order: 1 },
      { name: "Financial", description: "Financial assistance and benefits",
        content: "Financial assistance and benefits", icon: "DollarSign", color: "green", display_order: 2 },
      { name: "Veterans", description: "Veterans benefits and services",
        content: "Veterans benefits and services", icon: "Shield", color: "red", display_order: 3 },
      { name: "Safety", description: "Safety and protection services",
        content: "Safety and protection services", icon: "Shield", color: "rose", display_order: 4 },
      { name: "Support", description: "Support groups and organizations",
        content: "Support groups and organizations", icon: "Users", color: "purple", display_order: 5 },
      { name: "Nutrition", description: "Food assistance programs",
        content: "Food assistance programs", icon: "ShoppingBasket", color: "orange", display_order: 6 },
      { name: "Transportation", description: "Transportation services",
        content: "Transportation services", icon: "Car", color: "yellow", display_order: 7 },
      { name: "Housing", description: "Housing and home care",
        content: "Housing and home care", icon: "Home", color: "cyan", display_order: 8 },
      { name: "Emergency", description: "Crisis and emergency support",
        content: "Crisis and emergency support", icon: "Phone", color: "red", display_order: 9 },
      { name: "Education", description: "Educational resources",
        content: "Educational resources", icon: "GraduationCap", color: "indigo", display_order: 10 },
      { name: "Insurance", description: "Insurance information",
        content: "Insurance information", icon: "Shield", color: "teal", display_order: 11 },
      { name: "Technology", description: "Technology assistance",
        content: "Technology assistance", icon: "Monitor", color: "purple", display_order: 12 },
      { name: "Communication", description: "Communication support",
        content: "Communication support", icon: "MessageSquare", color: "blue", display_order: 13 },
      { name: "Legal", description: "Legal assistance and planning",
        content: "Legal assistance and planning", icon: "Scale", color: "gray", display_order: 14 },
      { name: "Caregiver", description: "Caregiver support and respite",
        content: "Caregiver support and respite", icon: "Heart", color: "pink", display_order: 15 },
      { name: "Disease-Specific", description: "Disease-specific organizations",
        content: "Disease-specific organizations", icon: "Activity", color: "purple", display_order: 16 },
      { name: "Home Modification", description: "Home safety and accessibility",
        content: "Home safety and accessibility", icon: "Wrench", color: "brown", display_order: 17 },
      { name: "Prescription", description: "Prescription assistance programs",
        content: "Prescription assistance programs", icon: "Pill", color: "emerald", display_order: 18 }
    ];
    ...
    const resources = [
      // ========== GOVERNMENT PROGRAMS (Core) ==========
      {
        ...
        content: "Federal health insurance for people 65 or older",
        content: "Medicare is the federal health insurance program for people who are 65 or older, certain younger people with disabilities, and people with End-Stage Renal Disease.",
      ...
      },
      {
        ...
        content: "State and federal health coverage for low-income individuals",
      ...
      },
      {
        ...
        content: "Retirement, disability, and survivor benefits",
      ...
      // ========== DISEASE-SPECIFIC ORGANIZATIONS ==========
      {
        ...
        content: "24/7 helpline for dementia support and resources",
      ...
      },
      {
        ...
        content: "Support and resources for Parkinson's patients",
      ...
      },
      {
        ...
        content: "24/7 cancer support, resources, and services",
      ...
      },
      {
        ...
        content: "Heart disease and stroke information and support",
      ...
      },
      {
        ...
        content: "Diabetes information, support, and resources",
      ...
      },
      {
        ...
        content: "Arthritis support, resources, and advocacy",
      ...
      },
      {
        ...
        content: "Support for chronic obstructive pulmonary disease",
      ...
      },
      {
        ...
        content: "Kidney disease information and support",
      ...
      },
      {
        ...
        content: "Support for Lewy body dementia patients and families",
      ...
      },
      {
        ...
        content: "Support for ALS (Lou Gehrig's Disease) patients",
      ...
      // ========== CAREGIVER SUPPORT ==========
      {
        ...
        content: "National resource center for family caregivers",
      ...
      },
      {
        ...
        content: "Respite care services for caregivers",
      ...
      },
      {
        ...
        content: "Support and resources for family caregivers",
      ...
      },
      {
        ...
        content: "Support for spousal caregivers",
      ...
      // ========== LEGAL & FINANCIAL PLANNING ==========
      {
        ...
        content: "Find elder law attorneys for estate and care planning",
      ...
      },
      {
        ...
        content: "Free legal assistance for seniors",
      ...
      },
      {
        ...
        content: "Consumer protection for elderly",
      ...
      },
      {
        ...
        content: "Financial literacy and planning resources",
      ...
      },
      {
        ...
        content: "Financial protection and complaint resolution",
      ...
      // ========== VETERANS SERVICES (Expanded) ==========
      {
        ...
        content: "Healthcare and benefits for military veterans",
      ...
      },
      {
        ...
        content: "24/7 confidential crisis support for veterans",
      ...
      },
      {
        ...
        content: "Benefits assistance for disabled veterans",
      ...
      },
      {
        ...
        content: "American Legion veterans support",
      ...
      // ========== PRESCRIPTION ASSISTANCE ==========
      {
        ...
        content: "Medicare prescription drug cost assistance",
        phoneNumber: "1-800-772-1213",
      ...
      },
      {
        ...
        content: "Prescription discount cards and price comparison",
      ...
      },
      {
        ...
        content: "Patient assistance program database",
      ...
      },
      {
        ...
        content: "Information on patient assistance programs",
      ...
      },
      {
        ...
        content: "Access to patient assistance programs",
      ...
      // ========== NUTRITION PROGRAMS (Expanded) ==========
      {
        ...
        content: "Supplemental Nutrition Assistance Program",
      ...
      },
      {
        ...
        content: "Home-delivered meals for homebound seniors",
      ...
      },
      {
        ...
        content: "Senior-specific food programs with home delivery",
      ...
      },
      {
        ...
        content: "Vouchers for fresh produce at farmers markets",
      ...
      },
      {
        ...
        content: "Monthly food boxes for seniors",
        phoneNumber: "1-703-305-2680",
      ...
      // ========== HOME MODIFICATION & SAFETY ==========
      {
        ...
        content: "Free home repairs and modifications for seniors",
      ...
      },
      {
        ...
        content: "Loans and grants for home repairs in rural areas",
      ...
      },
      {
        ...
        content: "Certified Aging-in-Place Specialists directory",
      ...
      // ========== TRANSPORTATION (Expanded) ==========
      {
        ...
        content: "Connect to local transportation services",
        phoneNumber: "1-800-677-1116",
      ...
      },
      {
        ...
        content: "Non-emergency medical transportation",
      ...
      },
      {
        ...
        content: "Ride services for seniors without smartphones",
      ...
      },
      {
        ...
        content: "Dignified transportation for seniors",
      ...
      // ========== TECHNOLOGY & DIGITAL LITERACY ==========
      {
        ...
        content: "Technology training and digital literacy for seniors",
      ...
      },
      {
        ...
        content: "Live online classes for older adults",
      ...
      },
      {
        ...
        content: "Tech training with youth mentors",
      ...
      },
      {
        ...
        content: "Free tutorials for popular websites and apps",
      ...
      // ========== EMERGENCY & CRISIS SUPPORT ==========
      {
        ...
        content: "24/7 mental health crisis support",
        phoneNumber: "988",
      ...
      },
      {
        ...
        content: "Crisis counseling for disaster survivors",
      ...
      },
      {
        ...
        content: "24/7 support for domestic violence victims",
      ...
      // ========== SAFETY & PROTECTION ==========
      {
        ...
        content: "Report elder abuse and get protection services",
        phoneNumber: "1-800-677-1116",
      ...
      },
      {
        ...
        content: "Report suspected elder abuse 24/7",
      ...
      },
      {
        ...
        content: "Resources and information on elder abuse prevention",
      ...
      },
      {
        ...
        content: "Find local elder abuse prevention services",
        phoneNumber: "1-800-677-1116",
        website: "https://eldercare.acl.gov",
        availableHours: "Mon-Fri 9:00 AM - 8:00 PM ET",
      ...
      // ========== SUPPORT ORGANIZATIONS ==========
      {
        ...
        content: "Resources, advocacy, and benefits for 50+ adults",
      ...
      },
      {
        ...
        content: "Programs and resources for aging well",
      ...
      },
      {
        ...
        content: "Advocates for residents in nursing homes & assisted living",
      ...
      },
      {
        ...
        content: "Intergenerational advocacy organization",
      ...
      // ========== HOUSING & HOME CARE ==========
      {
        ...
        content: "Local aging services and support programs",
        phoneNumber: "1-800-677-1116",
      ...
      },
      {
        ...
        content: "Affordable housing programs for seniors",
      ...
      },
      {
        ...
        content: "Shared housing options for seniors",
      ...
      },
      {
        ...
        content: "Community-based aging in place support",
      ...
      // ========== INSURANCE & MEDICARE ==========
      {
        ...
        content: "Free Medicare counseling and assistance",
      ...
      },
      {
        ...
        content: "Medicare advocacy and education",
      ...
      },
      {
        ...
        content: "Compare Medicare plans and prices",
        phoneNumber: "1-800-MEDICARE",
      ...
      // ========== EDUCATION & LIFELONG LEARNING ==========
      {
        ...
        content: "Educational programs for adults 50+",
        phoneNumber: "1-800-677-1116",
      ...
      },
      {
        ...
        content: "Health information from National Institutes",
      ...
      },
      {
        ...
        content: "Educational travel programs for older adults",
      ...
      },
      {
        ...
        content: "Computer and technology education for seniors",
      ...
      // ========== COMMUNICATION SUPPORT ==========
      {
        ...
        content: "Phone relay for deaf/hard of hearing",
        phoneNumber: "711",
      ...
      },
      {
        ...
        content: "Interpretation services for non-English speakers",
      ...
      },
      {
        ...
        content: "Free captioned telephone service",
      ...
      // ========== HEALTHCARE (Additional) ==========
      {
        ...
        content: "All-inclusive care for the elderly",
      ...
      },
      {
        ...
        content: "Find health centers and free/low-cost care",
      ...
      },
      {
        ...
        content: "Healthcare for American Indians and Alaska Natives",
    ...
    const educationalResourcesList = [
      {
        ...
        content: "Learn the fundamentals of Medicare coverage, enrollment periods, and how to choose the right plan",
      ...
      },
      {
        ...
        content: "Learn how to qualify for Medicaid while protecting your assets",
      ...
      },
      {
        ...
        content: "Ensure your healthcare wishes are known and respected",
        difficulty_level: "intermediate",
      ...
      },
      {
        ...
        content: "Learn about memory care options, costs, and how to choose the right facility",
        difficulty_level: "beginner",
      ...
      },
      {
        ...
        content: "Understanding Aid & Attendance, healthcare, and other VA benefits",
        difficulty_level: "intermediate",
      ...
      },
      {
        ...
        content: "Learn about coverage, costs, and when to purchase long-term care insurance",
        difficulty_level: "intermediate",
        reading_time_minutes: 20,
      ...
      },
      {
        ...
        content: "Comprehensive checklist to make your home safer for aging in place",
        difficulty_level: "beginner",
      ...
      },
      {
        ...
        content: "Learn self-care techniques and find support resources for caregivers",
        difficulty_level: "beginner",
        reading_time_minutes: 15,
      ...
      },
      {
        ...
        content: "Learn when to claim, spousal strategies, and how to avoid common mistakes",
        difficulty_level: "intermediate",
        reading_time_minutes: 25,
      ...
      },
      {
        ...
        content: "Learn how to assess care needs and choose the appropriate level of support",
        difficulty_level: "beginner",
        reading_time_minutes: 20,
