...
export function registerPlatformRoutes(app: Express) {
  ...
  // NOTE: Service details endpoint moved to main routes.ts to fetch from vendors table
  // This was causing a conflict - vendors are now fetched via /api/services/:id in routes.ts
