...
- **Free Tier Renaming** (August 5, 2025): Renamed free tier from 'verified' to 'basic' to avoid confusion about verification status. Communities are unverified until they claim a listing and complete email verification. This change required updates to database schema, server routes, and all client-side references. The tier structure is now: basic (free), standard ($149), featured ($249), platinum ($349).
